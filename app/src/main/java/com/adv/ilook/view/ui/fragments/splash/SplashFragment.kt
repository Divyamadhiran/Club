...
class SplashFragment : BaseFragment<FragmentSplashBinding>() {
    ...
    fun liveDataObserver() {
        ...
        viewModel.splashFieldsEnable.observe(viewLifecycleOwner){isEnable->
            Log.d(TAG, "liveDataObserver: ${isEnable}")
            remoteUIControl(isEnable)
        }
    ...
    private fun remoteUIControl(isEnable: Map<Int, Boolean>) {
        Log.d(TAG, "remoteUIControl: ")
        viewBinding?.apply {
            isEnable.forEach{(id,value)->
                when(id)
                {
                    backIView.id->  backIView.visibility= if (value) View.VISIBLE else View.GONE
                    headTextTV.id->  headTextTV.visibility= if (value) View.VISIBLE else View.GONE
                    childTextTV.id->  childTextTV.visibility= if (value) View.VISIBLE else View.GONE
                }
            }
        }
    }
    ...
    val runnableInner = {
        ...
        nav(R.id.action_splashFragment_to_selectScreenFragment) // goto home screen used this
