package com.adv.ilook.view.ui.fragments.dataclasses
...
data class AllContactsInfo(val contactNumber: String, val userName: String, var status: String, var isCforMeAcc:Boolean)