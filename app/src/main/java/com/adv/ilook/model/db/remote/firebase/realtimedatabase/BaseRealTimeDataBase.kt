...
import com.adv.ilook.model.data.firebasemodel.Post
import com.adv.ilook.model.data.firebasemodel.User
import java.util.HashMap

private const val TAG = "xxxBaseFireRealtimeDB"

abstract class BaseRealTimeDataBase(var database: DatabaseReference) {
   ...
   // private lateinit var database: DatabaseReference
    ...
    fun writeNewUser(userId: String, name: String, phone: String) {
    ...
    open fun writeNewUserWithTaskListeners(userId: String, name: String, email: String) {
