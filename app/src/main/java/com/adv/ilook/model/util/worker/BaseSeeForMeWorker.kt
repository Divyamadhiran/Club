    ...
    override suspend fun doWork(): Result {
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                val isCallFromActivity = inputData.getBoolean(WorkManagerKeys.CALL_ACTIVITY_KEY, false)

                val (result, data) = fetchNetworkData(false, sharedPrefKey, fileName, context, isCallFromActivity)
                Result.success(data)
